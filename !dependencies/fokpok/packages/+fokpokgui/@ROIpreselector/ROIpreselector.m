                ...
                if ~isfield(obj.handles,'rects')
                    ...
                    for i = 1:obj.numOfPoints
                        ...
                        obj.handles.rects(i).txt = text(obj.handles.ax,...
                                                        ...
                                                        'FontSize',14,'Color','w','VerticalAlignment','bottom');
                    end
                else
                    for i = 1:obj.numOfPoints
